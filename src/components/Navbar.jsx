            ...
            <form onSubmit={handleSubmit} className=' w-full'>
              <div className=' relative group'>
                ...
                <div className=' relative dynamic-gradient'>
                  ...
                  <input type="text" value={searchTem} onChange={(e) => setSearchTerm(e.target.value)} placeholder='Discover Your next read...' className=' block w-full rounded-2xl border border-gray-700/50 bg-gray-900/60 py-2 md:py-3 pl-10 md:pl-12 pr-4 md:pr-6 text-sm md:text-base text-gray-100 placeholder-gray-400 focus:outline-none focus:border-cyan-300/50 focus:ring-2 focus:ring-cyan-300/30 backdop-blur-xl shadow-xl transition-all duration-300 hover:bg-gray-900/80' />
